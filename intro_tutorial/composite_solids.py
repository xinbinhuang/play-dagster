...
@solid
def join_cereal(_context, cereals: DataFrame, manufacturers: DataFrame) -> DataFrame:
    manufacturers_lookup = {
        manufacturer["code"]: manufacturer["name"] for manufacturer in manufacturers
    }
        ...
        "solids": {
            "load_cereals": {
                "solids": {
                    ...
                    "read_manufacturers": {
                        "config": {"delimiter": ";"},
                        "inputs": {"csv_path": {"value": "./data/manufacturers.csv"}},
                    },
                }
            }
        }
